...
const PROCESS_COLUMNS: TableColumn<Process>[] = [
    ...
    { header: 'CPU',   accessor: (p) => `${p.cpu.toFixed(1)}%`, align: 'right', width: 6 },
        ...
        <Box flexDirection="column" paddingX={1}>
            ...
            >
                <Box flexDirection="column">
                    ...
                    <Text dimColor>
                        BigNumber · Gauge · LineChart · AreaChart · BarChart · PieChart ·
                        Sparkline · Heatmap · LogStream · PulseBar · Table
                    </Text>
                </Box>
            ...
            <Grid columns={5} rowHeight={14}>
                <GridItem span={4}>
                    <Panel title="LineChart — Throughput (CPU/Memory/Network)" borderStyle="round">
                        <LineChart
                            series={m.throughput}
                            showLegend
                            showAxis
                ...
                <GridItem>
                    <Box flexDirection="column" height={14}>
                        <Box height={7}>
                            <Panel title="Gauge — CPU" height={7} borderColor={C.success}>
                                <Box flexDirection="column" alignItems="center" justifyContent="center">
                                    ...
                                    />
                                    <Text dimColor>{Math.round(m.cpu)} / 100</Text>
                                </Box>
                            </Panel>
                        </Box>
                        <Box height={7}>
                            <Panel title="Gauge — Memory" height={7} borderColor={C.accent}>
                                <Box flexDirection="column" alignItems="center" justifyContent="center">
                                    <Gauge
                                        value={m.memory}
                                        min={0}
                                        ...
                                        emptyChar="·"
                                    />
                                    <Text dimColor>{Math.round(m.memory)} / 100</Text>
                                </Box>
                            </Panel>
                        </Box>
                    </Box>
            ...
            <Grid columns={3} rowHeight={14}>
                <GridItem>
                    <Panel title="AreaChart — Traffic & Cached" borderStyle="round" borderColor={C.success}>
                        <AreaChart
                ...
                <GridItem>
                    <Panel title="BarChart — Read & Write" borderStyle="round" borderColor={C.warn}>
                        <BarChart
            ...
            <Grid columns={3} rowHeight={4}>
                ...
                <GridItem>
                    <Panel title="Sparkline — braille" borderStyle="single" borderColor={C.purple}>
                        <Sparkline
                            data={m.sparkMem}
                            mode="character"
                            variant="braille"
                ...
                <GridItem>
                    <Panel title="Sparkline — auto + gradient" borderStyle="single" borderColor={C.warn}>
                        <Sparkline
                            data={m.sparkNet}
                            mode="auto"
                            color={C.warn}
            ...
            <Grid columns={3} rowHeight={14}>
                ...
                <GridItem>
                    <Panel title="Table — Process List" height={14} borderStyle="round">
                        <Table<Process>
                            data={PROCESS_LIST}
