#!/usr/bin/env node
/**
 * BarChart component example: Comparing two renderer charsets (Braille / Unicode Blocks)
 *
 * Optional parameters:
...
import { BarChart, InkHudProvider, Legend } from '../../src/index';
...
const App = () => (
    <Box flexDirection="column" padding={1} gap={1}>
        <Text bold underline color="blue">
            BarChart: Comparing charsets (renderers)
        </Text>
        <Text dimColor>
