#!/usr/bin/env node
/**
 * BarChart horizontal component example: Comparing three legend symbol sets (Unicode Geometry / Unicode Blocks / ASCII)
 *
 * Optional parameters:
...
import { BarChart, Legend } from '../../src/index.ts';
...
const App = () => (
    <Box flexDirection="column" padding={1} gap={1}>
        <Text bold underline color="blue">
            BarChart (Horizontal): Comparing three charsets (renderers)
        </Text>
        <Text dimColor>
        ...
        <Box flexDirection="row" gap={2} flexWrap="wrap">
            {renderersToShow.map(({ label, renderer, symbolSetId }) => {
                ...
                return (
                    <Box key={label} flexDirection="column" borderStyle="round" padding={1} width={46}>
