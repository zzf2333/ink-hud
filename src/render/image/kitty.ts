...
const DIACRITICS = [
    ...
    0x0829, 0x082A, 0x082B, 0x082C, 0x082D,
    // 129–131
    ...
    // 159–173
    0x1CD0, 0x1CD1, 0x1CD2, 0x1CDA, 0x1CDB, 0x1CE0, 0x1CE1, 0x1CE2,
    0x1CE3, 0x1CE4, 0x1CE5, 0x1CE6, 0x1CE7, 0x1CE8, 0x1CED,
    // 174–176
    0x1CF4, 0x1CF8, 0x1CF9,
    // 177–187
    0x1DC0, 0x1DC1, 0x1DC3, 0x1DC4, 0x1DC5, 0x1DC6, 0x1DC7, 0x1DC8,
    0x1DC9, 0x1DCB, 0x1DCC,
    // 188–210
    0x1DD1, 0x1DD2, 0x1DD3, 0x1DD4, 0x1DD5, 0x1DD6, 0x1DD7, 0x1DD8,
    0x1DD9, 0x1DDA, 0x1DDB, 0x1DDC, 0x1DDD, 0x1DDE, 0x1DDF, 0x1DE0,
    0x1DE1, 0x1DE2, 0x1DE3, 0x1DE4, 0x1DE5, 0x1DE6, 0x1DFE,
    // 211–222
    0x20D0, 0x20D1, 0x20D4, 0x20D5, 0x20D6, 0x20D7, 0x20DB, 0x20DC,
    0x20E1, 0x20E7, 0x20E9, 0x20F0,
    // 223–225
...
export function encodeKittyPlaceholders(
    ...
    for (let row = 0; row < rows; row++) {
        const rowMark = String.fromCodePoint(DIACRITICS[row]!);
        let line = colorSeq;
        for (let col = 0; col < cols; col++) {
            const colMark = String.fromCodePoint(DIACRITICS[col]!);
